...
export const BentoGridItem = ({
  ...
  const rightLists = ["Microservices", "Backend", "Postgres"];
  ...
  const handleCopy = () => {
    const text = "yuvrajchaudhary464@gmail.com";
  ...
  const getTime = () => {
    ...
    const timeString = `${hours}:${minutes.toString()} ${ampm} IST`;
    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {id === 2 && <BackgroundGradientAnimation></BackgroundGradientAnimation>}
